...
type cors struct {
	...
	allowOriginWithContextFunc func(*touka.Context, string) bool
	allowOrigins               []string
...
func (cors *cors) applyCors(c *touka.Context) {
...
func (cors *cors) isOriginValid(c *touka.Context, origin string) bool {
...
func (cors *cors) handlePreflight(c *touka.Context) {
...
func (cors *cors) handleNormal(c *touka.Context) {
	header := c.Writer.Header()
